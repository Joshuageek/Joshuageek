...
$use_image_logo = file_exists($_SERVER['DOCUMENT_ROOT'] . $logo_path) && !empty($logo_path);
...
$menu_items = [
  ...
  ['label' => 'About Us', 'url' => './pages/public/about.php'],
  ['label' => 'For Therapists', 'url' => '/pages/public/clinic.php'],
  ['label' => 'Contact Us', 'url' => '/pages/public/contact.php'],
  ['label' => 'Sign In', 'url' => './public/auth/login.php'],
];
...
//         $menu_items[] = ['label' => 'Contact Us', 'url' => 'booking.php'];
...
<head>
    ...
    * {
    ...
    .navbar .container {
        padding-left: 0;
        /* Remove left padding to push logo to edge */
    }
    ...
    .hamburger {
        margin-left: auto;
        /* Push these elements to the right */
    }
