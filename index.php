...
<section id="hero-section">
    <div class="container">
        ...
        <h1 class="fs-3 fw-bold text-danger">User Id: <?php echo $user_id ?? 'NO ID';  ?></h1> -->
                ...
                <p class="subtitle">
                <h4>Connect with licensed therapists in minutes. Accessible, confidential support designed for young
                    adults.</h4>
                </p>
...
.image-container {
    ...
    overflow: visible;
    margin-bottom: 60px;
    /* Space for badges that extend below */
}
        ...
        <div class="hero-services">
            <a class="hero_service individual" href="#">
                <div class="hero__service-img-wrap">
                    <img sizes="(max-width: 558px) 100vw, 558px" src="/images/ind.jpg" alt="Individual" loading="lazy"
                        class="hero__service-img">
                </div>
            ...
            <a class="hero_service teens" href="#">
                <div class="hero__service-img-wrap">
                    <img sizes="(max-width: 558px) 100vw, 558px" src="/images/some.jpg" alt="Teens" loading="lazy"
                        class="hero__service-img">
                </div>
            ...
            <a class="hero_service couples" href="#">
                <div class="hero__service-img-wrap">
                    <img sizes="(max-width: 558px) 100vw, 558px" src="/images/couple.jpg" alt="Couples" loading="lazy"
                        class="hero__service-img">
                </div>
            ...
            <a class="hero_service medication" href="#">
                <div class="hero__service-img-wrap">
                    <img sizes="(max-width: 558px) 100vw, 558px" src="/images/med.jpg" alt="Medication" loading="lazy"
                        class="hero__service-img">
                </div>
        ...
        <table class="compare-table">
            ...
            <tbody>
                <tr>
                    ...
                    <td>
                        <div class="check-circle"><i class="fa fa-check check"></i></div>
                    </td>
                    <td>
                        <div class="check-circle"><i class="fa fa-times x-mark"></i></div>
                    </td>
                </tr>
                <tr>
                ...
                <div class="blog-item">
                    <div class="popup-wrapper">
                        <div class="popup-gallery">
                            <a href="#" class="blog-item-pic"><span class="eye-wrapper"><i
                                        class="pe-7s-link eye-icon"></i></span></a>
                        </div>
                    </div>
                    <div class="blog-item-inner">
                        <h3 class="blog-title"><a href="#">Match with a Therapist</a></h3>
                        <p>Answer a few quick questions about your healthcare needs, and we’ll connect you to a
                            qualified therapist who fits your preferences.</p>
            ...
            <div class="col-md-4 wow bounceInUp">
                <div class="blog-item">
                    ...
                    <div class="blog-item-inner">
                        ...
                        <p>Join your appointment through a secure link. Get personalized care and ongoing support
                        ...
                        <ul>
                            ...
                            <li data-index="rs-326" data-transition="fade" data-slotamount="7" data-easein="default"
                                ...
                                <div class="testimonial-card">
                                    ...
                                    <p class="testimonial-text">As an introvert, the idea of getting mental health
                                        support from the comfort of my room makes me feel seen. I'm really looking
                                        forward to this.</p>
                            ...
                            <li data-index="rs-327" data-transition="fade" data-slotamount="7" data-easein="default"
                                ...
                                <div class="testimonial-card">
                                    <div class="quote-icon">"</div>
                                    <p class="testimonial-text">After having my baby, I went through a lot emotionally,
                                        but I didn't know where to turn. Speaking to a therapist without leaving the
                                        house makes me feel less alone.</p>
                                    <div class="testimonial-author">
                                        <h4>Diana K.</h4>
                                        <p>Kampala</p>
                                    </div>
                            ...
                            <li data-index="rs-328" data-transition="fade" data-slotamount="7" data-easein="default"
                                ...
                                <div class="testimonial-card">
                                    <div class="quote-icon">"</div>
                                    <p class="testimonial-text">As a student, it's hard to find affordable therapy. I
                                        can't wait for an option that's both easy to access and doesn't break the bank.
                                    </p>
                                    <div class="testimonial-author">
                                        <h4>Joel A.</h4>
                            ...
                            <li data-index="rs-329" data-transition="fade" data-slotamount="7" data-easein="default"
                                ...
                                <div class="testimonial-card">
                                    <div class="quote-icon">"</div>
                                    <p class="testimonial-text">Sometimes it's hard to find someone to talk to,
                                        especially when you're far from the city. Being able to get help without
                                        traveling miles would make such a difference.</p>
                                    <div class="testimonial-author">
                                        <h4>Roland, M</h4>
                            ...
                            <li data-index="rs-330" data-transition="fade" data-slotamount="7" data-easein="default"
                                ...
                                <div class="testimonial-card">
                                    <div class="quote-icon">"</div>
                                    <p class="testimonial-text">The convenience of telemedicine is a game changer. It
                                        means quicker access to mental healthcare for my family.</p>
                                    <div class="testimonial-author">
                                        <h4>Rebecca N</h4>
                                        <p>Entebbe</p>
                                    </div>
                            ...
                            <li data-index="rs-331" data-transition="fade" data-slotamount="7" data-easein="default"
                                ...
                                <div class="testimonial-card">
                                    <div class="quote-icon">"</div>
                                    <p class="testimonial-text">The idea that Luna Health could bring help straight to
                                        us, no matter where we are, is really comforting.</p>
                                    <div class="testimonial-author">
                                        <h4>Kenneth M</h4>
                                        <p>Bugolobi</p>
                                    </div>
...
.section-title {
    ...
    font-weight: 700;
    margin-bottom: 60px;
    /* Increased spacing between title and cards */
    color: #2D3436;
