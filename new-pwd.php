...
<head>
    ...
    <title>SwiftDoc - Generate Password</title>
...
<div class="login-container">
    <div class="text-center mb-4">
        ...
        <h5 class="mt-3">Generate Password</h5>
    </div>
    ...
    <form action="php/auth.inc.php" method="POST">
        ...
        <button type="submit" class="btn btn-login w-100" name="first_pwd">Submit Password</button>
    </form>
</div>
